...
namespace ERecord.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            try
            {
                var employee = _context.Users.First(u => u.UserName == model.Email);
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                return RedirectToAction("Pending", "Employee");
                }
                AddErrors(result);
            }
        ...
        ////   For Admin to Create a User Profile *********************************************************************************************************************************
        ...
        public async Task<ActionResult> Create(AdminCreateViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser
                {
                    ...
                    DateCreated = DateTime.Now,
                    IsActive = model.IsActive,
                    EmploymentDay = model.EmploymentDay,
                    SchoolAttended = model.SchoolAttended,
                    MaximumQulaification = model.MaximumQulaification,
                    ServiceYear = model.ServiceYear,
                    LastPromoted = model.LastPromoted,
        ...
        {
            ViewBag.LogoffMessage = "You've been logged off. Thanks for checking in.";
